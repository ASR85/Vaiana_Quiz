...
import com.arnaudlcelestino.vaiana_quizz.model.Utilisateur;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_jouer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent fenetreJeux = new Intent(com.arnaudlcelestino.vaiana_quizz.controller.MainActivity.this, Fenetre_Quizz.class);
